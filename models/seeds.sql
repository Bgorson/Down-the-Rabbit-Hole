-- Add User
INSERT INTO projecttwo.Users (email, password, createdAt, updatedAt) VALUES
('user_1@email.com', 'password', NOW(), NOW()),
('user_2@email.com', 'password', NOW(), NOW());

-- Add Posts
INSERT INTO projecttwo.Posts
...
-- Add Comments
INSERT INTO projecttwo.Comments (text, createdAt, updatedAt, PostId) VALUES
('comment_1', NOW(), NOW(), 1),
('comment_2', NOW(), NOW(), 2);
